...
export default function EditChapter() {
  ...
  const API_URL = `http://localhost:5000/api/chapters/${id}`;
  ...
  if (fetching) {
    return (
      <div style={{ 
        ...
        <p style={{ fontSize: "18px", color: "#0c4a6e", fontWeight: 600 }}>Loading chapter...</p>
      </div>
    );
  }
      ...
      <div className="dashboard-container">
        ...
        <aside className={`sidebar ${sidebarOpen ? "open" : ""}`}>
          <div className="logo-container">
            <img src={Logo} alt="Oz Citizen Logo" className="logo-img" />
          </div>
